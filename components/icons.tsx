...
export const Pin: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 17v5" /><path d="M15 9.34a8 8 0 1 0-6 0" /><path d="M12 3v6" /><path d="M6 9h12" /></svg>
);
...
export const Sparkles: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.94 15.06 12 13l2.06 2.06 2.06-2.06-2.06-2.06 2.06-2.06-2.06-2.06-2.06 2.06-2.06-2.06 2.06 2.06-2.06 2.06Z" /><path d="M3 9.5 5.5 7l-2.5-2.5L7 2l2.5 2.5L7 7l2.5 2.5Z" /><path d="M18 17.5 15.5 15l2.5 2.5L15.5 20l2.5-2.5L20.5 20l-2.5-2.5Z" /></svg>
);
...
export const FileJson: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 22h14a2 2 0 0 0 2-2V7.5L14.5 2H6a2 2 0 0 0-2 2v4" /><path d="M14 2v6h6" /><path d="M12 18h-1a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h1" /><path d="M10 22v-1a2 2 0 0 1 2-2h1a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2h-1" /></svg>
);
